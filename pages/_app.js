...
export default function App({ Component, pageProps }) {
  ...
  const [showWhattsapp, setShowWhattsapp] = useState(false)
  const [disclimerVisible, setDisclimerVisible] = useState(false)
  ...
  useEffect(() => {
    // set Whattsapp Show
    setShowWhattsapp(true)

    if(router.route === '/') setDisclimerVisible(true)
  }, [router])
